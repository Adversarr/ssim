...
constexpr double p13_f_f[4][4] = {{1.0 / 60, 1.0 / 120, 1.0 / 120, 1.0 / 120},
                                  {1.0 / 120, 1.0 / 60, 1.0 / 120, 1.0 / 120},
                                  {1.0 / 120, 1.0 / 120, 1.0 / 60, 1.0 / 120},
                                  {1.0 / 120, 1.0 / 120, 1.0 / 120, 1.0 / 60}};

constexpr double p13_pfpx_f[4][4][3] = {{{-(1.0 / 24), -(1.0 / 24), -(1.0 / 24)},
...
constexpr double p13_pfpx_pfpx[4][4][3][3]
